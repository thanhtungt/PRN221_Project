...
namespace BussinessObject.Models
{
    public partial class FUFlowerBouquetManagementContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connectString = "server =(local); database = FUFlowerBouquetManagement;uid=sa;pwd=lienminh;";
            ...
            // Chỉ cấu hình chuỗi kết nối nếu chưa được thiết lập bởi DI
            if (!optionsBuilder.IsConfigured)
            {
                IConfiguration config = new ConfigurationBuilder()
                    .SetBasePath(Directory.GetCurrentDirectory())
                ...
                var connectString = config.GetConnectionString("FUFlowerBouquetManagementDB");
